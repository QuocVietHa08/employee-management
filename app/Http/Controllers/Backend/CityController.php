...
class CityController extends Controller
{
    ...
    public function store(CityStoreRequest $request)
    {
        ...
        return redirect()->route('cities.index')->with('message','Create new city successfully');
    ...
    public function update(CityStoreRequest $request, City $city)
    {
        ...
        return redirect()->route('cities.index')->with('message','Update City successfully');
    ...
    public function destroy(City $city)
    {
        ...
        return redirect()->route('cities.index')->with('message','Delete City Successfully');
