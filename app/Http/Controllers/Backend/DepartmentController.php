...
class DepartmentController extends Controller
{
    ...
    public function store(DepartmentStoreRequest   $request)
    {
        ...
        return redirect()->route('departments.index')->with('message','Create new department successfully');
    }
    ...
    public function destroy(Department $department)
    {
        ...
        return redirect()->route('departments.index')->with('message', 'Delete department successfully');
    }
}
